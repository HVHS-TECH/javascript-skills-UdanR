...
function getFormInfo (){
    ...
    if (tax_money <= TAX_BRACKET_ONE){
        orginal_money = tax_money;
        var taxed_amount = tax_money*TAX_BRACKET_ONE_AMOUNT/100;
         afterTax = (tax_money - taxed_amount);
    } else if (tax_money <=TAX_BRACKET_TWO){
        orginal_money = tax_money;
        tax_money = tax_money-15600;
        var taxed_amount = (TAX_BRACKET_TWO_AMOUNT/100*tax_money)+1638;
         afterTax = (orginal_money - taxed_amount);
    } else if (tax_money <=TAX_BRACKET_THREE){
        orginal_money = tax_money;
        tax_money=tax_money-53500;
        var taxed_amount = (TAX_BRACKET_THREE_AMOUNT/100*tax_money)+1638+6632.5;
         afterTax = (orginal_money - taxed_amount);
    } else if (tax_money <=TAX_BRACKET_FOUR){
        orginal_money = tax_money;
        tax_money=tax_money-78100;
        var taxed_amount = (TAX_BRACKET_FOUR_AMOUNT/100*tax_money)+1638+6632.5+7380;
         afterTax = (orginal_money - taxed_amount);
    } else {
        orginal_money = tax_money;
        tax_money=tax_money-180000;
        var taxed_amount = (TAX_BRACKET_FIVE_AMOUNT/100*tax_money)+1638+6632.5+7380+33627;
         afterTax = (orginal_money - taxed_amount);
    }
